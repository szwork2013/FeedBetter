(module
 ...
 (data (i32.const 224) "no chart object found\00")
 ...
 (data (i32.const 736) "issuer account does not exist\00")
 (data (i32.const 768) "date_end can not be smaller then now.\00")
 (data (i32.const 816) "date_end can not be smaller then date_start.\00")
 (data (i32.const 864) "category can not be bigger than 5\00")
 (data (i32.const 912) "question can not be empty\00")
 (data (i32.const 944) "age can not be bigger than 4\00")
 (data (i32.const 976) "age can not be bigger than 2\00")
 (data (i32.const 1008) "answer1 can not be empty\00")
 (data (i32.const 1040) "answer2 can not be empty\00")
 (data (i32.const 1072) "magnitude of asset amount must be less than 2^62\00")
 (data (i32.const 1136) "invalid symbol name\00")
 (data (i32.const 1168) "cannot transfer to self\00")
 ...
 (data (i32.const 1360) "memo has more than 256 bytes\00")
 (data (i32.const 1392) "success\00")
 ...
 (func $_ZN5eosio11multi_indexILy14316861271951405952EN10feedbetter11surveychartEJEE6modifyIZNS1_12submitsurveyEyyyE4$_16EEvRKS2_yOT_ (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i64)
  (local $4 i64)
  (local $5 i32)
  (local $6 i32)
