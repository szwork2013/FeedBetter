(module
 ...
 (data (i32.const 1232) "success\00")
 ...
 (func $_ZNK5eosio11multi_indexILy14316861270987767808EN10feedbetter9surveyansEJEE31load_object_by_primary_iteratorEl (param $0 i32) (param $1 i32) (result i32)
  ...
  (block $label$2
   ...
   (set_local $6
    (call $_ZN5eosio11multi_indexILy14316861270987767808EN10feedbetter9surveyansEJEE4itemC2IZNKS3_31load_object_by_primary_iteratorElEUlRT_E_EEPKS3_OS6_
     (tee_local $4
      (call $_Znwj
       (i32.const 48)
      )
 ...
 (func $_ZN5eosio11multi_indexILy14316861270987767808EN10feedbetter9surveyansEJEE4itemC2IZNKS3_31load_object_by_primary_iteratorElEUlRT_E_EEPKS3_OS6_ (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (i64.store offset=16 align=4
   (get_local $0)
   (i64.const 0)
