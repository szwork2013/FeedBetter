(module
 ...
 (data (i32.const 688) "issuer account does not exist\00")
 (data (i32.const 720) "date_end can not be smaller then now.\00")
 (data (i32.const 768) "date_end can not be smaller then date_start.\00")
 (data (i32.const 816) "category can not be bigger than 5\00")
 (data (i32.const 864) "question can not be empty\00")
 (data (i32.const 896) "age can not be bigger than 4\00")
 (data (i32.const 928) "age can not be bigger than 2\00")
 (data (i32.const 960) "answer1 can not be empty\00")
 (data (i32.const 992) "answer2 can not be empty\00")
 ...
 (data (i32.const 1280) "symbol precision mismatch\00")
 (data (i32.const 1312) "memo has more than 256 bytes\00")
 (data (i32.const 1344) "success\00")
 (data (i32.const 1360) "object passed to iterator_to is not in multi_index\00")
